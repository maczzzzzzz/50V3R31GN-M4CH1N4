...
impl CyberdeckApp {
    ...
    fn render_netrun_tab(&self, ui: &mut egui::Ui) {
        ...
        let status = format!(
            "NETRUNNER HUD v3.8.27-SYNTHESIS-SYNTHESIS-SYNTHESIS-SYNTHESIS-SYNTHESIS-SYNTHESIS-SYNTHESIS-SYNTHESIS-SYNTHESIS-SYNTHESIS-SYNTHESIS-SYNTHESIS-SYNTHESIS-SYNTHESIS-SYNTHESIS-SYNTHESIS-SYNTHESIS-SYNTHESIS-SYNTHESIS-SYNTHESIS | NODES: {} | INTRUSION: {:.0}%",
            node_count,
