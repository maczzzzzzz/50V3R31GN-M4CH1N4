...
6. **Sovereign Shards (CRITICAL):** ALL implementation phases MUST include a corresponding "Ability Shard" (`scripts/gauntlet/phases/*.ts`) to enable live-fire verification and manifest control.
