  ...
  async start(port: number): Promise<void> {
    ...
    await new Promise<void>((resolve, reject) => {
      ...
      server.on('connection', (ws: WebSocket, req: IncomingMessage) => {
        ...
        this.sendChatMessage('🟢 **Link Established** — 50V3R31GN-M4CH1N4 Orchestrator (v3.8.25-SYNTHESIS-SYNTHESIS-SYNTHESIS-SYNTHESIS-SYNTHESIS-SYNTHESIS-SYNTHESIS-SYNTHESIS-SYNTHESIS-SYNTHESIS-SYNTHESIS-SYNTHESIS-SYNTHESIS) is now online.', { alias: 'System' }).catch(() => {});
