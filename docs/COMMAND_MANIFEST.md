# ５０Ｖ３Ｒ３１ＧＮ－Ｍ４ＣＨ１Ｎ４: Command & Bridge Manifest (v2.3.0)
...
| `pnpm run obsidian:sync` | Launches the bidirectional Obsidian-to-RKG sync daemon. |
...
| `ZEROCLAW-KERNEL` | Rules Oracle, 7R1_SC0R3R context compression, and mechanical reality enforcement. | Node A (Rust) |
