# Design Specification: Phase 11 — Neural Uplink (v3.4.1)
...
- **2nd Signature:** "Destructive" UI actions (e.g. deleting actors) still require the v3.4.1 `ACK` signature in the terminal.
