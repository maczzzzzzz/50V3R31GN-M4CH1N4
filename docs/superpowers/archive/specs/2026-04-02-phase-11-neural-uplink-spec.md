# Design Specification: Phase 11 — Neural Uplink (v3.8.7)
...
- **2nd Signature:** "Destructive" UI actions (e.g. deleting actors) still require the v3.8.7 `ACK` signature in the terminal.
