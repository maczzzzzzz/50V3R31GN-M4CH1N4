# Design Specification: Phase 11 — Neural Uplink (v3.8.28-GOLD)
...
- **2nd Signature:** "Destructive" UI actions (e.g. deleting actors) still require the v3.8.28-GOLD `ACK` signature in the terminal.
