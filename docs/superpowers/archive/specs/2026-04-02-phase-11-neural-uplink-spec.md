# Design Specification: Phase 11 — Neural Uplink (v3.6.0)
...
- **2nd Signature:** "Destructive" UI actions (e.g. deleting actors) still require the v3.6.0 `ACK` signature in the terminal.
