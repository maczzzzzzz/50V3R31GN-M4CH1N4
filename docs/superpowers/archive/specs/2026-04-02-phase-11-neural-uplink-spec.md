# Design Specification: Phase 11 — Neural Uplink (v3.2.17)
...
- **2nd Signature:** "Destructive" UI actions (e.g. deleting actors) still require the v3.2.17 `ACK` signature in the terminal.
