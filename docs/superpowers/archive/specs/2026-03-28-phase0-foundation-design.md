...
All schemas are derived from direct inspection of actual seed data in `docs/raw_data/`. Field optionality reflects what was observed in the real Foundry VTT v12 exports from `cyberpunk-red-core` v3.8.0.
