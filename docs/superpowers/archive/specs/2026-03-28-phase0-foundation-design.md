...
All schemas are derived from direct inspection of actual seed data in `docs/raw_data/`. Field optionality reflects what was observed in the real Foundry VTT v12 exports from `cyberpunk-red-core` v3.2.21.
...
### 3.6 `roll-table.schema.ts` — Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Oracle & random tables
...
| Solo Play Core Tools | 11-26 | Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Oracle system, NPC reaction tables, scene generation |
