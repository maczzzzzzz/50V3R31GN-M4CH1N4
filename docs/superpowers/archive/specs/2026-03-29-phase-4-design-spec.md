...
- Depend strictly on `simple-phone v3.8.24-SYNTHESIS-SYNTHESIS-SYNTHESIS`, `Ticket-To-The-Afterlife v3.8.24-SYNTHESIS-SYNTHESIS-SYNTHESIS`, and `night-city-gang-and-corp-mook-pack v2.8` on Foundry v12.
