...
It uses 1-bit Bonsai 8B on the Nitro 5 for deterministic Rules Strategic Strategic Oracle duties and Mistral-Nemo 12B (FP8) on the main rig for rich narrative, linked by ClawLink.
...
Node A (Nitro 5 – headless): Rules Strategic Strategic Oracle
...
Rules/math always resolved by 1-bit Strategic Strategic Oracle before narrative
