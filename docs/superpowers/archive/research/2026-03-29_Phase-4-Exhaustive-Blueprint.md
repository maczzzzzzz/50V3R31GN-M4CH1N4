...
2.  **Roll Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Oracle / Math:** The player attempts a task. Node A (`nitro-logic`) resolves the DV and returns the JSON result.
