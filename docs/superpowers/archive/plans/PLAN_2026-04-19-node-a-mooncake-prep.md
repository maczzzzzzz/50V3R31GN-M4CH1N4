...
- [ ] **Step 2: Clean up legacy binaries and weights**
  - Run: `rm -rf ~/50v3r31gn-m4ch1n4-v3.8.24-SYNTHESIS-SYNTHESIS-SYNTHESIS/zeroclaw/models/*.gguf`
  - Run: `rm -rf ~/50v3r31gn-m4ch1n4-v3.8.24-SYNTHESIS-SYNTHESIS-SYNTHESIS/zeroclaw/models/*.onnx`
