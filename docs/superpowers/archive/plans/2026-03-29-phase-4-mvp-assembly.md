...
- Wire `storyEngine` into `handleResolveAttack` and `handleStrategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic OracleRoll`.
