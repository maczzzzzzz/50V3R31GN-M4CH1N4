...
**Date:** 2026-04-03
**Target:** v3.8.28-SYNTHESIS-SYNTHESIS-SYNTHESIS-SYNTHESIS-SYNTHESIS-SYNTHESIS-SYNTHESIS-SYNTHESIS-SYNTHESIS-SYNTHESIS-SYNTHESIS-SYNTHESIS-SYNTHESIS-SYNTHESIS-SYNTHESIS-SYNTHESIS-SYNTHESIS-SYNTHESIS-SYNTHESIS-SYNTHESIS-SYNTHESIS-SYNTHESIS-SYNTHESIS-SYNTHESIS-SYNTHESIS-SYNTHESIS-SYNTHESIS+ (Phase 18)
...
*   *Light Tasks:* Math, D10 Strategic Oracle, OCR Vision -> Routed to Node A (Rust/Falcon/Open-Reasoner-Zero-1.5B 4GB).
*   *State Safety:* If Node A is currently swapping models (e.g., unloading Open-Reasoner-Zero-1.5B to warm up Falcon for Vision), the Proxy queues incoming Strategic Oracle requests instead of failing.
