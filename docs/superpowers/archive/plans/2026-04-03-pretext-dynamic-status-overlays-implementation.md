...
describe('HybridRoutingController - Damage Thresholds', () => {
  it('triggers a pretext overlay for netDamage >= 15', async () => {
    // Mock dependencies: unifiedStrategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Oracle, foundryAdapter, nitroLogic, etc.
