...
**Goal:** Establish the "Black-Ice" visual identity in Foundry v3.6.0 and implement the Human-in-the-Loop authorization barrier for world-state writes.
...
**Files:**
- Create: `docs/audits/2026-04-02_v3.6.0-Hardening-Audit.md`
