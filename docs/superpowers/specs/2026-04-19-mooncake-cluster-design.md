...
**Goal:** Implement a distributed inference mesh using Mooncake v2.2 to share KV-cache between Node B (Director) and Node C (Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Oracle), hosted on Node A (Synapse Synapse).
...
| **Node C** | **Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Oracle** | Server / 2060 | Logic Client (L1 Cache) |
