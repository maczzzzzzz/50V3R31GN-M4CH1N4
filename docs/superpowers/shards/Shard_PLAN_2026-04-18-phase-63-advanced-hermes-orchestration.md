...
- [ ] **Step 1: Add Hermes Tooling to the Strategic Oracle Shell**
...
Mount the `HermesProxy` within the main `page.tsx` layout to ensure the GM has immediate visibility of the Hermes Strategic Oracle state.
