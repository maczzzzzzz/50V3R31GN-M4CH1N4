...
3.  **Semantic Mapping:** Node C (Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Oracle) maps the user's intent (e.g., "Open Market") to the AXTree node (e.g., `role: "button", name: "Night Market"`).
4.  **Shard Generation:** Strategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Oracle generates a surgical Go patch or JSON repair.
