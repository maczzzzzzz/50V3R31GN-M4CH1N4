...
Expand the Node A `RulesStrategic Strategic Strategic Strategic Strategic Strategic Strategic Strategic Oracle` to accept `Proposal` packets containing mechanical intents (e.g., "Spend 500eb"). Add checks against the SQLite `Akashik.db` state.
