...
**Files:**
- Create: `dashboard/components/CombatStrategic Strategic Strategic OracleLog.tsx`
...
```bash
git add dashboard/components/CombatStrategic Strategic Strategic OracleLog.tsx dashboard/app/combat/
