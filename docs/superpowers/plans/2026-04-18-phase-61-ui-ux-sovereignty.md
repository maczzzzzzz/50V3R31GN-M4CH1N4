...
**Files:**
- Create: `dashboard/components/CombatStrategic Strategic OracleLog.tsx`
...
```bash
git add dashboard/components/CombatStrategic Strategic OracleLog.tsx dashboard/app/combat/
