...
```bash
cd /home/nixos/asp-gm-agent/crush && go test ./... -run "TestSt3gg" -v 2>&1 | head -20
```
...
```bash
cd /home/nixos/asp-gm-agent/crush && go test ./... -run "TestSt3gg" -v
```
...
```bash
cd /home/nixos/asp-gm-agent/crush && go test ./...
```

Expected: `ok github.com/asp-gm-agent/crush`

- [ ] **Step 6: Commit**

```bash
cd /home/nixos/asp-gm-agent && git add crush/st3gg.go crush/st3gg_test.go && git commit -m "$(cat <<'EOF'
...
```bash
cd /home/nixos/asp-gm-agent/crush && go get golang.org/x/image
```
...
```bash
cd /home/nixos/asp-gm-agent/crush && go test ./... -run "TestFindPairs" -v 2>&1 | head -20
```
...
```bash
cd /home/nixos/asp-gm-agent/crush && go test ./... -run "TestFindPairs" -v
```
...
```bash
cd /home/nixos/asp-gm-agent && git add crush/forge.go crush/forge_test.go crush/go.mod crush/go.sum && git commit -m "$(cat <<'EOF'
...
```bash
cd /home/nixos/asp-gm-agent/crush && go test ./... -run "TestForgeAsset|TestForgeRun" -v 2>&1 | head -20
```
...
```bash
cd /home/nixos/asp-gm-agent/crush && go test ./... -run "TestForgeAsset|TestForgeRun|TestFindPairs" -v
```
...
```bash
cd /home/nixos/asp-gm-agent && git add crush/forge.go crush/forge_integration_test.go && git commit -m "$(cat <<'EOF'
...
```bash
cd /home/nixos/asp-gm-agent/crush && go test ./... -run "TestRunForge" -v 2>&1 | head -20
```
...
```bash
cd /home/nixos/asp-gm-agent/crush && go test ./... -run "TestRunForge" -v
```
...
```bash
cd /home/nixos/asp-gm-agent/crush && go build ./... && ./crush forge 2>&1 | head -8
```
...
```bash
cd /home/nixos/asp-gm-agent && git add crush/forge.go crush/forge_cli_test.go crush/main.go && git commit -m "$(cat <<'EOF'
