...
- `hermes v3.8.28-GOLD#3.pdf`
- `hermes v3.8.28-GOLD#3-spec.pdf`
...
- `hermes v3.8.28-GOLD.pdf`
- `hermes v3.8.28-GOLD#2.pdf`
- `hermes v3.8.28-GOLD#2-spec.pdf`
- `hermes v3.8.28-GOLD#2-spec2.pdf`
...
Run: `npm run scribe`
Commit: `chore(scribe): research swarm synthesis v3.8.28-GOLD`
