...
- `hermes v3.8.24-SYNTHESIS-#3.pdf`
- `hermes v3.8.24-SYNTHESIS-#3-spec.pdf`
...
- `hermes v3.8.24-SYNTHESIS.pdf`
- `hermes v3.8.24-SYNTHESIS-#2.pdf`
- `hermes v3.8.24-SYNTHESIS-#2-spec.pdf`
- `hermes v3.8.24-SYNTHESIS-#2-spec2.pdf`
...
Run: `npm run scribe`
Commit: `chore(scribe): research swarm synthesis v3.8.24-SYNTHESIS`
