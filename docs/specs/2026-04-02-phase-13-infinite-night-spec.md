# Design Specification: Phase 13 — The Infinite Night (v1.2.0)
**Subject:** Procedural Campaign Generation & Map Ingestion Engine
**Status:** DESIGN FINALIZED (Audit Hardened)

## 1. Executive Summary
Phase 13 establishes the ASP.GM-Agent as a self-sovereign procedural engine. It enables the AI to ingest custom map assets, synthesize complex mission beats from raw rules/lore, and physically materialize them in Foundry VTT via the Phase 11 Neural Uplink.
...
## 3. Communication Protocol (v1.2.0)
