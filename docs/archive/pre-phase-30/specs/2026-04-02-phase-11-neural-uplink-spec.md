# Design Specification: Phase 11 — Neural Uplink (v1.0.0)
...
- **2nd Signature:** "Destructive" UI actions (e.g. deleting actors) still require the v1.0.3 `ACK` signature in the terminal.
