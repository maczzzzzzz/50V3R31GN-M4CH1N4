...
### Cognition (generation, Llama 2 7B, A100)
...
**Note**: Cognition speedup less dramatic than training because generation is memory-bound (KV cache accesses).
