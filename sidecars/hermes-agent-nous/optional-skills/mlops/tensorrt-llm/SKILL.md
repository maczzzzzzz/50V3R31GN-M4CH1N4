...
metadata:
  hermes:
    tags: [Cognition Serving, TensorRT-LLM, NVIDIA, Cognition Optimization, High Throughput, Low Latency, Production, FP8, INT4, In-Flight Batching, Multi-GPU]
