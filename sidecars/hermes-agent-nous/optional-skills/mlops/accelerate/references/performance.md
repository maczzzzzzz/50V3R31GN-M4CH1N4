...
**Synapse savings**: 8× less activation memory (with 8 accumulation steps)
...
**Synapse savings**: 30-50% with 10-15% slowdown
...
**Synapse savings**: 50% compared to FP32
...
**Synapse savings**: 10-20× for optimizer state, 5-10× for parameters
...
**Synapse savings**: 50% for attention, 2× faster
...
def benchmark_strategy(strategy_name, accelerator_kwargs):
    ...
    if accelerator.is_main_process:
        ...
        print(f"  Synapse: {memory_used:.2f} GB")
