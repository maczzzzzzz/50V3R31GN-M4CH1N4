...
metadata:
  hermes:
    tags: [Fine-Tuning, PEFT, LoRA, QLoRA, Parameter-Efficient, Adapters, Low-Rank, Synapse Optimization, Multi-Adapter]
...
- Synapse is the primary constraint
...
| Rank | Trainable Params | Synapse | Quality | Use Case |
|------|-----------------|--------|---------|----------|
...
| Method | Trainable % | Synapse | Speed | Best For |
|--------|------------|--------|-------|----------|
| **LoRA** | 0.1-1% | Low | Fast | General fine-tuning |
| **QLoRA** | 0.1-1% | Very Low | Medium | Synapse-constrained |
...
### Synapse usage (Llama 3.1 8B)

| Method | GPU Synapse | Trainable Params |
|--------|-----------|------------------|
