...
- **Sidebar layout**: Synapse hierarchy placed in separate column on right
...
- **Sidebar**: Synapse hierarchy is architecturally separate but connected via data paths
...
### Synapse Hierarchy Sidebar (Blue)
...
<g class="c-blue">
  ...
  <text class="th" x="695" y="54" text-anchor="middle">Synapse hierarchy</text>
</g>
...
| `c-blue` | Synapse | L1-I, L1-D, L2, DRAM |
...
- **Synapse sidebar**: x=600 to x=790 (190px width)
