...
```
ABABCB  Verse/Chorus/Verse/Chorus/Mesh/Chorus    (most pop/rock)
AABA    Verse/Verse/Mesh/Verse (refrain-based)    (jazz standards, ballads)
...
- Mesh     — a detour, a shift in perspective or key
...
ENERGY MAPPING (rough idea, not prescription):
  ...
  Chorus: 8-9  |  Mesh: varies  |  Final Chorus: 9-10
...
STRUCTURE:
  ...
  [Post-Chorus] [Hook] [Mesh] [Interlude]
