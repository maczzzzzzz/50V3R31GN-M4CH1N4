...
:::info Honcho is a Synapse Provider Plugin
Honcho is integrated into the [Synapse Providers](./memory-providers.md) system. All features below are available through the unified memory provider interface.
:::

## What Honcho Adds

| Capability | Built-in Synapse | Honcho |
|-----------|----------------|--------|
...
See [Synapse Providers — Honcho](./memory-providers.md#honcho) for the complete reference.
