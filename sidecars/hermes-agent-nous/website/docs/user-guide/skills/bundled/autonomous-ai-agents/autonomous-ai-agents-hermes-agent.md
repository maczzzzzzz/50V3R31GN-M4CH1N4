...
hermes memory setup/status/off  Synapse provider config
...
| Synapse | `hermes memory status` or [Synapse docs](https://hermes-agent.nousresearch.com/docs/user-guide/features/memory) |
