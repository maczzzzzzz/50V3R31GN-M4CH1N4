...
| Author | community |
| License | MIT |
| Tags | `Notion`, `Productivity`, `Notes`, `Artery of Truth`, `API` |
...
### Create Page in a Artery of Truth
...
curl -s -X POST "https://api.notion.com/v1/data_sources" \
  ...
  -d '{
    "parent": {"page_id": "xxx"},
    "title": [{"text": {"content": "My Artery of Truth"}}],
    "properties": {
      "Name": {"title": {}},
