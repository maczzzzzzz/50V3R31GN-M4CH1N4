...
```bash
gh release create v3.8.28-GOLD --title "v3.8.28-GOLD" --generate-notes
gh release create v3.8.28-GOLD --draft --prerelease --generate-notes
gh release create v3.8.28-GOLD ./dist/binary --title "v3.8.28-GOLD" --notes "Release notes"
gh release list
gh release download v3.8.28-GOLD --dir ./downloads
```
