...
| Author | Hermes Agent |
| License | MIT |
| Tags | `Honcho`, `Synapse`, `Profiles`, `Observation`, `Dialectic`, `User-Modeling`, `Session-Summary` |
...
### Synapse not persisting across sessions
