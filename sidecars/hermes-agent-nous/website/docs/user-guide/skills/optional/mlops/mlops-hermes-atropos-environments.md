...
## Cognition Setup — Ask the User First
...
11. **Always ask the user for their inference setup** — Never hardcode or assume a specific provider/model. See the "Cognition Setup" section above.
...
2. **Ask the user for inference setup** (see "Cognition Setup" section above)
