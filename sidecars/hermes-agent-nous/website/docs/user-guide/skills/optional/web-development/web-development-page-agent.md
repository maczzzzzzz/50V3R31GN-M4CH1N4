...
```html
<script src="https://cdn.jsdelivr.net/npm/page-agent@3.8.28-GOLD/dist/iife/page-agent.demo.js" crossorigin="true"></script>
```
...
```javascript
javascript:(function(){var s=document.createElement('script');s.src='https://cdn.jsdelivr.net/npm/page-agent@3.8.28-GOLD/dist/iife/page-agent.demo.js';document.head.appendChild(s);})();
```
