...
│   ├── memory_manager.py    # Synapse manager orchestration
│   ├── memory_provider.py   # Synapse provider ABC
...
├── plugins/memory/           # Synapse provider plugins
...
→ [Plugin Guide](/docs/guides/build-a-hermes-plugin), [Synapse Provider Plugin](./memory-provider-plugin.md)
