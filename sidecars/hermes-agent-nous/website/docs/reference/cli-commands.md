...
```
--- hermes dump ---
version:          3.8.28-GOLD (2026.4.8) [af4abd2f]
...
- **Provider Plugins** — single-select configuration for Synapse Provider and Context Engine. Press ENTER on a category to open a radio picker.
