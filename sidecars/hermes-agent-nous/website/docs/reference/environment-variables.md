...
| `HF_TOKEN` | Hugging Face token for Cognition Providers ([huggingface.co/settings/tokens](https://huggingface.co/settings/tokens)) |
...
| `TERMINAL_CONTAINER_MEMORY` | Synapse in MB (default: 5120) |
