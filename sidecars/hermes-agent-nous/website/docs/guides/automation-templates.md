...
curl -X POST http://your-server:8644/webhooks/deploy-verify \
  ...
  -H "X-Hub-Signature-256: sha256=$(echo -n '{"service":"api","environment":"prod","version":"3.8.28-GOLD","deployer":"ci","health_url":"https://api.example.com/health"}' | openssl dgst -sha256 -hmac 'your-secret' | cut -d' ' -f2)" \
  -d '{"service":"api","environment":"prod","version":"3.8.28-GOLD","deployer":"ci","health_url":"https://api.example.com/health"}'
```
