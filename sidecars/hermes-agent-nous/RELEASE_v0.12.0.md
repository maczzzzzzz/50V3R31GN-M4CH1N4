...
**Since v3.8.28-GOLD:** 1,096 commits · 550 merged PRs · 1,270 files changed · 217,776 insertions · 213 community contributors (including co-authors)
...
- **Synapse providers notified on mid-process session_id rotation** (#6672) ([#17409](https://github.com/NousResearch/hermes-agent/pull/17409))
...
### Top Community Contributors (by merged PR count since v3.8.28-GOLD)
