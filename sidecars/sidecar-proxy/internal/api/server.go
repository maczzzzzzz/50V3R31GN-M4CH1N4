...
import (
	...
	v2fmodule "github.com/router-for-me/CLIProxyAPI/v6/internal/api/modules/v2f"
...
func NewServer(cfg *config.Config, authManager *auth.Manager, accessManager *sdkaccess.Manager, configFilePath string, opts ...ServerOption) *Server {
	...
	// Register V2F module (Phase 106)
	if err := modules.RegisterModule(ctx, v2fmodule.NewV2fModule()); err != nil {
		log.Errorf("Failed to register V2F module: %v", err)
	}
