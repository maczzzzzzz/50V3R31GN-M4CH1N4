...
func TestApplyClaudeHeaders_UsesConfiguredBaselineFingerprint(t *testing.T) {
	...
	incoming := http.Header{
		...
		"X-Stainless-Runtime-Version": []string{"v3.8.28-GOLD"},
	...
	assertClaudeFingerprint(t, req.Header, "evil-client/9.9", "9.9.9", "v3.8.28-GOLD", "Linux", "x64")
...
func TestApplyClaudeHeaders_TracksHighestClaudeCLIFingerprint(t *testing.T) {
	...
	assertClaudeFingerprint(t, firstReq.Header, "claude-cli/2.1.62 (external, cli)", "0.74.0", "v3.8.28-GOLD", "MacOS", "arm64")
	...
	assertClaudeFingerprint(t, thirdPartyReq.Header, "claude-cli/2.1.62 (external, cli)", "0.74.0", "v3.8.28-GOLD", "MacOS", "arm64")
	...
	assertClaudeFingerprint(t, higherReq.Header, "claude-cli/2.1.63 (external, cli)", "0.75.0", "v3.8.28-GOLD", "MacOS", "arm64")
	...
	assertClaudeFingerprint(t, lowerReq.Header, "claude-cli/2.1.63 (external, cli)", "0.75.0", "v3.8.28-GOLD", "MacOS", "arm64")
}
...
func TestApplyClaudeHeaders_DoesNotDowngradeConfiguredBaselineOnFirstClaudeClient(t *testing.T) {
	...
	assertClaudeFingerprint(t, olderClaudeReq.Header, "claude-cli/2.1.70 (external, cli)", "0.80.0", "v3.8.28-GOLD", "MacOS", "arm64")
	...
	assertClaudeFingerprint(t, newerClaudeReq.Header, "claude-cli/2.1.71 (external, cli)", "0.81.0", "v3.8.28-GOLD", "MacOS", "arm64")
}
...
func TestApplyClaudeHeaders_UpgradesCachedSoftwareFingerprintWhenBaselineAdvances(t *testing.T) {
	...
	assertClaudeFingerprint(t, officialReq.Header, "claude-cli/2.1.71 (external, cli)", "0.81.0", "v3.8.28-GOLD", "MacOS", "arm64")
	...
	assertClaudeFingerprint(t, thirdPartyReq.Header, "claude-cli/2.1.77 (external, cli)", "0.87.0", "v3.8.28-GOLD", "MacOS", "arm64")
}
...
func TestApplyClaudeHeaders_LearnsOfficialFingerprintAfterCustomBaselineFallback(t *testing.T) {
	...
	assertClaudeFingerprint(t, officialReq.Header, "claude-cli/2.1.77 (external, cli)", "0.87.0", "v3.8.28-GOLD", "MacOS", "arm64")
	...
	assertClaudeFingerprint(t, postLearningThirdPartyReq.Header, "claude-cli/2.1.77 (external, cli)", "0.87.0", "v3.8.28-GOLD", "MacOS", "arm64")
}
...
func TestApplyClaudeHeaders_ThirdPartyBaselineThenOfficialUpgradeKeepsPinnedPlatform(t *testing.T) {
	...
	assertClaudeFingerprint(t, thirdPartyReq.Header, "claude-cli/2.1.70 (external, cli)", "0.80.0", "v3.8.28-GOLD", "MacOS", "arm64")
...
func TestApplyClaudeHeaders_DisableDeviceProfileStabilization(t *testing.T) {
	...
	assertClaudeFingerprint(t, firstReq.Header, "claude-cli/2.1.62 (external, cli)", "0.74.0", "v3.8.28-GOLD", "Linux", "x64")
	...
	assertClaudeFingerprint(t, thirdPartyReq.Header, "claude-cli/2.1.60 (external, cli)", "0.10.0", "v3.8.28-GOLD", "Windows", "x64")
	...
	assertClaudeFingerprint(t, lowerReq.Header, "claude-cli/2.1.61 (external, cli)", "0.73.0", "v3.8.28-GOLD", "Windows", "x64")
}
...
func TestApplyClaudeHeaders_LegacyModePreservesConfiguredUserAgentOverrideForClaudeClients(t *testing.T) {
	...
	assertClaudeFingerprint(t, req.Header, "config-ua/1.0", "0.74.0", "v3.8.28-GOLD", "Linux", "x64")
}
...
func TestApplyClaudeHeaders_LegacyModeFallsBackToRuntimeOSArchWhenMissing(t *testing.T) {
	...
	assertClaudeFingerprint(t, req.Header, "claude-cli/2.1.60 (external, cli)", "0.70.0", "v3.8.28-GOLD", helps.MapStainlessOS(), helps.MapStainlessArch())
}
