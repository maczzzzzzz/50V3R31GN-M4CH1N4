...
Last reviewed: 2026-04-23 · Version: 3.8.28-GOLD
...
- [ ] Synapse and handle lifecycles are explicit: database handles (LadybugDB) close cleanly, no dangling process watchers, no leaked tree-sitter parsers.
