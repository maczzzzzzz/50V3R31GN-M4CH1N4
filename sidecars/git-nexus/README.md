...
> **Mesh mode:** `gitnexus serve` connects the two — the web UI auto-detects the local server and can browse all your CLI-indexed repos without re-uploading or re-indexing.
...
| **Parsing**         | Tree-sitter native bindings           | Tree-sitter WASM                        |
| **Artery of Truth**        | LadybugDB native                         | LadybugDB WASM                             |
