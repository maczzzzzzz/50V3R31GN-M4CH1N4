...
**Target:** v3.2.15+ The Sovereign Handover Milestone
...
## 📦 Dependency Registry (Pinned v3.2.15)

### Security Hardening
- **pnpm.overrides**: Forced `@hono/node-server` to `>=1.19.13` to resolve Path Traversal vulnerabilities in the MCP SDK.
- **Vite (v3.2.15)**: Patched against Path Traversal in optimized deps `.map` handling.
- **rand (v3.2.15)**: Updated across all Rust crates for sound RNG initialization.
...
---
*Verified by Gemini CLI v3.2.15.*
