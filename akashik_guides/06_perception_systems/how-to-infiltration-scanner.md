...
- **Normal Mode:** Node A performs a 1d10 roll against the target's grounded stats.
- **Sovereign Mode:** If enabled (`crush sovereign-mode on`), the roll is bypassed for a guaranteed critical success.
...
---
*Status: Infiltration Protocol Active. v2.4.0 Stabilized.*
