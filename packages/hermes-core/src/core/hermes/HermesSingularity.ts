...
export class HermesSingularity {
  ...
  /**
   * Orchestrate a long-running Research Swarm (v3.8.24-SYNTHESIS-SYNTHESIS)
   */
  ...
  /**
   * Experience-Gitting (v3.8.24-SYNTHESIS-SYNTHESIS): Log failure trajectories for future reasoning.
   */
  ...
  public async invoke(input: SingularityInput): Promise<SingularityResult> {
    ...
    const systemPrompt = "[IMPORTANT: HERMES_SINGULARITY_ORCHESTRATOR v3.8.24-SYNTHESIS-SYNTHESIS]";
