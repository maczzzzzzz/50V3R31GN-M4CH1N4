      ...
      body: Column(
        children: [
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return GeometricShard(
                  borderColor: isUser ? const Color(0xFF376374) : const Color(0xFFC7A87A),
                  title: Text("::/${msg.sender.toUpperCase()}", style: TextStyle(color: isUser ? const Color(0xFF376374) : const Color(0xFFC7A87A), fontSize: 9, fontWeight: FontWeight.w900, letterSpacing: 2)),
          ...
          if (chatService.isSyncing)
            const LinearProgressIndicator(minHeight: 2, color: Color(0xFF376374), backgroundColor: Colors.transparent),
          Container(
      ...
      child: Column(
        children: [
          const DrawerHeader(
            ...
            child: Center(
              child: Text('LOG_ARCHIVE', style: TextStyle(color: Color(0xFF376374), fontSize: 18, fontWeight: FontWeight.w900, letterSpacing: 4, fontFamily: 'Cinzel')),
            ),
          ),
          Expanded(
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return GeometricShard(
                  borderColor: isSelected ? const Color(0xFF376374) : const Color(0xFF262626),
                  onTap: () {
