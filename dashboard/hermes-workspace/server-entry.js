...
import { readFile, stat, readFile as fsRead } from 'node:fs/promises'
import { join, extname } from 'node:path'
import { fileURLToPath } from 'node:url'
import { existsSync, readFileSync } from 'node:fs'

// Sovereign Artery: Explicitly load .env before anything else
...
// Dynamically import the server to prevent ES module hoisting from evaluating it before process.env is populated
