      ...
      {!isVisuallyCollapsed && (
        ...
        >
          <Link
            ...
            className={cn(
              buttonVariants({ variant: 'ghost', size: 'sm' }),
              'relative w-full overflow-hidden justify-start gap-2.5 px-3 py-2 text-primary-900 hover:bg-primary-200 dark:hover:bg-primary-800',
              isNewSessionActive &&
                'bg-accent-500/10 text-accent-500 hover:bg-accent-50 dark:hover:bg-accent-900/300/15',
            )}
          ...
          >
            <div className="relative z-10 flex items-center gap-2.5">
              <HugeiconsIcon
                ...
                className="size-5 shrink-0"
              />
              <span className={cn(isNewChatHovered && 'opacity-0')}>
                New Session
              </span>
            </div>
            {isNewChatHovered && (
